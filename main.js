	...
	for ( var funcName in functionConstraints )
	{
		...
		for( var c = 0; c < constraints.length; c++ )
		{
			...
			if( params.hasOwnProperty( constraint.ident ) )
			{
				...
				else if((constraint.ident == "dir" && constraint.ident == "fileExists")||(constraint.ident == "filePath" && constraint.ident == "fileWithContent"))
				{	params[constraint.ident] = constraint.value;}
			}
					...
					if( child.type === 'BinaryExpression' && child.operator == "==")
					{
						...
						if( child.left.type == 'Identifier' && child.left.name == "area")
						{
							...
							functionConstraints[funcName].constraints.push(
								...
								{
									ident: params[0],
									value: "'("+rightHand.substring(1,4)+")" + "222-2222'",
									funcName: funcName,
									kind: "string",
									operator : child.operator,
									expression: expression
